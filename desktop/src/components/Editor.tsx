...
import { OPENING_PRESETS, PRESETS, api } from "../api";
import { doorSwingPolygon, findCollisions, findObstructions, wallFrame } from "../geometry";
import type { LayoutDetail, Opening, Placement, RoomDetail, Selection } from "../types";
import { FloorPlan } from "./FloorPlan";
import { OpeningInspector, PlacementInspector } from "./Inspector";
...
export function Editor({ roomId, onBack }: { roomId: string; onBack: () => void }) {
  ...
  const obstructions = useMemo(() => {
    ...
    return findObstructions(placements, swings);
  }, [placements, openings, walls]);
    ...
    <div className="shell">
      ...
      <div className="workspace">
        <aside className="panel panel--left">
          ...
          <h2 style={{ marginTop: 10 }}>Add furniture</h2>
          {PRESETS.map((preset) => (
        ...
        <aside className="panel panel--right">
          ...
          {selectedPlacement && (
            <PlacementInspector
              ...
              blocksDoor={obstructions.some((o) => o.placementId === selectedPlacement.id)}
          ...
          {selectedOpening && (
            <OpeningInspector
              ...
              walls={walls}
              blockedBy={
                obstructions.filter((o) => o.openingId === selectedOpening.id).length
              }
